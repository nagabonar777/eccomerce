    ...
    <div class="">
      ...
      <nav aria-label="Footer Navigation" class="text-gray-500">
        <ul class="space-y-3">
          ...
          <li><a class="hover:text-blue-600 hover:underline" href="/contact">Contact</a></li>
        </ul>
      </nav>
    </div>
    <div class="">
      <div class="mt-4 mb-2 font-medium xl:mb-4 text-bold">Subscribe to <span class="text-black-600 font-bold"> Chanz</span><span class="text-red-600 font-bold">Store</span>.</div>

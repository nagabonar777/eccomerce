...
<section class="mx-auto max-w-2xl px-4 py-16 bg-gray-100 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        ...
        <div class="px-4 py-6 sm:px-8 sm:py-10">
          <div class="flow-root">
            <ul class="-my-8">
              ...
              <li class="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                <div class="shrink-0">
                  <img class="h-24 w-24 max-w-full rounded-lg object-cover" src="https://www.creativefabrica.com/wp-content/uploads/2020/09/01/letter-C-logo-design-Vector-design-Graphics-5225857-1.jpg" alt="" />
                </div>
                ...
                <div class="relative flex flex-1 flex-col justify-between">
                  ...
                  <div class="absolute top-0 right-0 flex sm:bottom-0 sm:top-auto">
                    <button type="button" @click="removeItem(cart.cart_id)" class="flex rounded p-2 text-center text-gray-500 transition-all duration-200 ease-in-out focus:shadow hover:text-gray-900">
                      <svg class="h-5 w-5" xmlns="http://www
          ...
          <div class="mt-6 border-t border-b py-2">
            <div class="flex items-center justify-between">
              ...
              <p class="text-lg font-semibold text-gray-900">{{ (totalHarga()).toLocaleString('id-ID',{style: 'currency',currency:'IDR'}) }}</p>
            </div>
            <div class="flex items-center justify-between">
          ...
          <div class="mt-6 text-center">
            <a href="/checkout">
            <button type="button" class="group inline-flex w-full items-center justify-center rounded-md bg-red-900 px-6 py-4 text-lg font-semibold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-gray-800">
              Checkout
              <svg xmlns="http://www.w3.org/2000/svg"
               class="group-hover:ml-8 ml-4 h-6 w-6 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
export default {
  ...
  computed: {
    ...
    methods: {
      ...
      ...mapActions('product', ['fetchPruduct']),
      totalHarga() {

        ...
        <div class="px-4 py-6 sm:px-8 sm:py-10">
          ...
          <div class="mt-6 border-t border-b py-2">
            ...
            <div class="flex items-center justify-between">
              ...
              <p class="text-lg font-semibold text-gray-900">{{(ongkir).toLocaleString('id-ID',{style: 'currency',currency:'IDR'}) }}</p>
            </div>
          </div>
          <div class="mt-6 flex items-center justify-between">
            <p class="text-sm font-medium text-gray-900">Total</p>
            <p class="text-2xl font-semibold text-gray-900"><span class="text-xs font-normal text-gray-400"> </span>{{ (totalHarga() + ongkir).toLocaleString('id-ID',{style: 'currency',currency:'IDR'}) }} </p>
          </div>

      ...
      <div class="container mx-auto px-4">
        <div class="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
          ...
          <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
            <h1 class="sm: text-2xl font-bold text-gray-900 sm:text-3xl">{{ singleProduct.name }}</h1>
             <span>{{ singleProduct.slug }}</span>
            ...
            <div class="flex items-center mt-5">
               <span @click="kurang"
                class="cursor-pointer rounded-l bg-gray-100 py-1 px-3.5 duration-100 hover:bg-black hover:text-yellow-50">-</span>
            ...
            <div
              ...
              <div v-if="token">
                <button @click="addToCart(singleProduct.id)" type="button" 
